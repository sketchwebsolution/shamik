        ...
        <div class="col-md-12">
            ...
            <div class="box box-warning">
                <div class="box-body">
                    ...
                    <form role="form" action="<?php echo $this->config->item('base_url'); ?>cms/admin/cmsupdate/<?php echo!empty($cmslist->id) ? urlencode(base64_encode($cmslist->id)) : ''; ?>" method="post" id="cms_form">
                        <!-- text input -->
