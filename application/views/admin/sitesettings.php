                ...
                <div class="box-body">
                  <form  enctype="multipart/form-data" id="site_settings" name="site_settings" role="form" action="<?php echo $this->config->item('base_url');?>admin/siteupdate" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="siteemail" placeholder="Enter Site Email" value="<?php echo $sitesettings->siteemail;?>"/>
                    </div>

                    <div class="form-group">
                      <label>Site Address</label>
                      <textarea class="form-control" name="siteaddress" placeholder="Enter Site Address"><?php echo $sitesettings->siteaddress;?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="youtube_link" placeholder="Enter Youtube Link" value="<?php echo $sitesettings->youtube_link;?>" />
                    </div>
