        ...
        <div class="col-md-12">
            ...
            <div class="box box-warning">
                <div class="box-body">
                    ...
                    <form role="form" action="<?php echo base_url('cms/admin/cmsupdate');?>/<?php echo!empty($cmslist->id) ? urlencode(base64_encode($cmslist->id)) : ''; ?>" method="post" id="cms_form">
                        <!-- text input -->
    ...
    if (!empty($cmslist->meta_key)) {
        ?> 
               ...
               <?php //echo html_entity_decode($cmslist->meta_description, ENT_QUOTES, 'utf-8'); ?>
                                     <?php echo stripslashes($cmslist->meta_description); ?>  
