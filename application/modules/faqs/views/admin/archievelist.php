            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <input type="button" class="btn btn-primary pull-right" value="Back" onclick="window.location.href='<?php echo site_url('admin/faqs');?>'" />
                       ...
                       ?>
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="javascript:void(0);" onclick="window.location.href='<?php echo base_url('faqs/admin/deleteData/'.urlencode(base64_encode($row->id)));?>'"><span><i class="fa fa-times"></i></span></a>&nbsp;<a href="<?php echo $this->config->item('base_url');?>faqs/admin/updateres/<?php echo urlencode(base64_encode($row->id));?>"><span><i class="fa fa-fast-backward"></i></span></a>
